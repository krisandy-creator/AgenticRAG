        ...
        <div v-for="(item, index) in historyChatStore.chatArr" :key="index" class="message-group">
          ...
          <div v-if="item.aiMessage.content || (!sendQuestion && index === historyChatStore.chatArr.length - 1)" class="ai-message" :class="item.aiMessage.type ? 'ai-message-' + item.aiMessage.type : ''">
            ...
            <div class="message-content">
              ...
              <template v-else>
                <div v-if="item.aiMessage.type === 'knowledge'" style="color: #ff9f43;">
        ...
        <div v-if="fileUrl" class="uploaded-file-tag">
          <span class="file-avatar" aria-hidden="true">
            ...
            <svg v-else width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M21.44 11.05l-7.07 7.07a5 5 0 01-7.07-7.07l7.07-7.07a3 3 0 114.24 4.24l-7.07 7.07a1 1 0 01-1.41-1.41l6.36-6.36" stroke="#ff9f43" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </span>
...
.input-area {
  ...
  background-color: #ffffff;
  box-shadow: 0 -4px 12px rgba(255, 159, 67, 0.05);
  ...
  .uploaded-file-tag {
    ...
    font-size: 12px;
    z-index: 10;
    box-shadow: 0 4px 8px rgba(255, 159, 67, 0.1);
