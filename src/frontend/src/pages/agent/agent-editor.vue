...
.agent-editor {
  ...
  &::before {
    ...
    right: 0;
    height: 300px;
    background: linear-gradient(135deg, #ff9f43 0%, #ff8c1a 50%, #ff6b6b 100%);
    opacity: 0.03;
    z-index: 0;
  }
    ...
    .header-left {
      ...
      .back-btn {
        ...
        &:hover {
          ...
          background: linear-gradient(135deg, #ff8c1a 0%, #e67e22 100%);
        }
      ...
      .header-info {
        ...
        .header-icon {
          color: #ff9f43;
          font-size: 26px;
          filter: drop-shadow(0 2px 4px rgba(255, 159, 67, 0.2));
        }
    ...
    .header-actions {
      ...
      .cancel-btn {
        ...
        &:hover {
          ...
          color: #ff9f43;
          background: #fffbf7;
          box-shadow: 0 4px 16px rgba(255, 159, 67, 0.1);
  ...
  .editor-body {
    ...
    .center-panel {
      ...
      border-radius: 24px;
      box-shadow: 
        0 8px 32px rgba(255, 159, 67, 0.1),
      ...
      .panel-header {
        ...
        .header-content {
          ...
          .panel-icon {
            ...
            font-size: 22px;
            margin-bottom: 4px;
            filter: drop-shadow(0 2px 4px rgba(255, 159, 67, 0.15));
          }
          ...
          :deep(.el-textarea__inner) {
            ...
            &:focus {
              ...
              box-shadow: 
                ...
                0 8px 24px rgba(255, 159, 67, 0.08),
          ...
          .section-header {
            ...
            .section-title {
              ...
              .section-icon {
                color: #ff9f43;
                font-size: 18px;
                filter: drop-shadow(0 1px 2px rgba(255, 159, 67, 0.2));
      ...
      .memory-toggle-wrapper {
        ...
        .memory-toggle-btn {
          ...
          &:hover {
            transform: translateY(-1px);
            box-shadow: 
              0 4px 16px rgba(255, 159, 67, 0.1),
              inset 0 1px 0 rgba(255, 255, 255, 0.7);
          }
      ...
      .form-select {
        :deep(.el-input__wrapper) {
          ...
          &:hover {
            ...
            transform: translateY(-1px);
            box-shadow: 
              0 4px 12px rgba(255, 159, 67, 0.05),
              inset 0 1px 0 rgba(255, 255, 255, 0.7);
          }
