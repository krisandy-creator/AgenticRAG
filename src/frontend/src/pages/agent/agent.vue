      ...
      <div class="header-actions">
        ...
        <div class="action-buttons">
          ...
          <el-button 
            ...
            @click="createAgent"
            size="large"
            style="border-radius: 12px; background: linear-gradient(135deg, #ff9f43 0%, #ff8c1a 100%); border: none;"
          >
            创建智能体
          </el-button>
        </div>
...
.agent-page {
  ...
  .page-header {
    ...
    box-shadow: 0 4px 20px rgba(255, 159, 67, 0.1); // 减小了阴影
    ...
    .header-title {
      ...
      h2 {
        ...
        font-size: 24px;
        font-weight: 600;
        background: linear-gradient(90deg, #ff9f43, #ff8c1a); // 与robot.svg图标颜色匹配
