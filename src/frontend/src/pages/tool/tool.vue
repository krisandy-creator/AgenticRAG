...
.tool-page {
  ...
  .tool-list {
    .tool-row {
      ...
      &:hover {
        background: linear-gradient(to right, rgba(255, 159, 67, 0.02), rgba(255, 140, 26, 0.02));
...
.empty-state {
  ...
  .empty-visual {
    ...
    .empty-icon-wrapper {
      ...
      justify-content: center;
      align-items: center;
      background: linear-gradient(135deg, rgba(255, 159, 67, 0.08) 0%, rgba(255, 140, 26, 0.08) 100%);
      border-radius: 50%;
      position: relative;
