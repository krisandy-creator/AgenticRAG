        ...
        .form-section {
          ...
          .form-select {
            .el-input__wrapper {
              ...
              &:hover {
                border-color: #ffbc7b;
                background: linear-gradient(135deg, #f1f5f9 0%, #fff3e0 100%);
              ...
              &.is-focus {
                border-color: #ff9f43;
                background: white;
                box-shadow: 0 0 0 4px rgba(255, 159, 67, 0.1), 0 8px 24px rgba(0, 0, 0, 0.12);
          ...
          .action-btn {
            ...
            &.primary-btn {
              ...
              &:hover {
                ...
                box-shadow: 0 12px 28px rgba(255, 159, 67, 0.4);
              }
            }
          }
        }
